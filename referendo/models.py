...
class Signer(models.Model):
    ...
    signer_rg_number = models.CharField(max_length=10, null=True, blank=True)
    signer_rg_issuing_authority = models.CharField(max_length=10, null=True, blank=True)
    ...
    pin_code = models.CharField(max_length=9, null=True, blank=True)
    email_otp = models.CharField(max_length=6, blank=True, null=True)
    mobile_otp = models.CharField(max_length=6, blank=True, null=True)
    otp_created_at = models.DateTimeField(null=True, blank=True)
    
    # New fields for digital signing:
    signer_hash = models.CharField(max_length=255, blank=True, null=True)
